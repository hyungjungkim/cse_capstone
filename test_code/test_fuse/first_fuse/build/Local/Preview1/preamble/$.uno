...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.0.30"), 12124)}, "/Users/kimhyungjung/Desktop/capstone/test_code/test_fuse/first_fuse/first_fuse.unoproj", new string[] { ""})
{
